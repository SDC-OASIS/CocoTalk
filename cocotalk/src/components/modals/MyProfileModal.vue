	...
	<div class="modal row" @click.self="closeProfileModal">
		<div class="modal-container" :style="{ backgroundImage: `url(${userInfo.background})` }" @click.self="openFullImg(userInfo.background)">
			...
			<div class="modal-bottom-container">
				<div class="profile-modal-info" @click.self="openFullImg(userInfo.background)">
					<div style="cursor: pointer; display: inline-block" @click="openFullImg(userInfo.profile)">
				...
				<hr />
				<div class="modal-profile-chat" style="width: 100%; display: inline-block">
