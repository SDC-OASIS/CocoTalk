				...
				<div>
					...
					<div class="make-chat-modal-info row" style="justify-content: left">
						<div class="friend-list-container" :style="{ height: height }">
							...
							<div class="friend-container row" v-for="(friend, idx) in searchFriends" :key="idx">
								...
								<input v-model="selectedFriends" type="checkbox" :for="'check' + idx" :value="friend.username" />
							</div>
						</div>
